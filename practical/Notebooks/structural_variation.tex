...
\begin{Verbatim}[commandchars=\\\{\}]
breakdancer\PYZhy{}max \PYZhy{}\PYZhy{}help
\end{Verbatim}
\end{tcolorbox}
...
\item
  ...
  structural variant software (lumpy)?
\end{enumerate}
...
\setcounter{enumi}{2}
\item
  What type of SV event occurs at position IV:383993? What is the length
  of the SV event?
\item
  What type of SV event occurs at position XV:43018? What is the length
  of the SV event?
\end{enumerate}
...
\texttt{YPS128.10x.filtered\_subreads.sorted.bam}. \textbf{Hint:} Use
samtools sort.
...
\prompt{In}{incolor}{ }{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
samtools calmd YPS128.filtered\PYZus{}subreads.10x.fastq.sorted.bam ../ref/Saccharomyces\PYZus{}cerevisiae.R64\PYZhy{}1\PYZhy{}1.dna.toplevel.fa \PY{p}{|}samtools view \PYZhy{}o YPS128.filtered\PYZus{}subreads.10x.fastq.sorted.calmd.bam \PYZhy{}O bam \PYZhy{}
\end{Verbatim}
\end{tcolorbox}
